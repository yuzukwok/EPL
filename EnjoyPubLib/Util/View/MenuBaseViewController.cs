...
//            _title.ShadowOffset = new SizeF(0, 1);
		...
		public class MenuElement :EnjoyPubLib.Util.ElementUtil.StyledStringElement
		{
				...
				: base(title, tapped)
			{
				...
				TextColor = UIColor.FromRGB(16, 79, 103);
...
//                    TextLabel.ShadowOffset = new SizeF(0, -1); 
					SelectedBackgroundView = new UIView { BackgroundColor = UIColor.FromRGB(51, 130, 255) };
